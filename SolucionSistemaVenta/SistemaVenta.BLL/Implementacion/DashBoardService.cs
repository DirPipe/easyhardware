...
namespace SistemaVenta.BLL.Implementacion
{
    public class DashBoardService : IDashBoardService
    {
        ...
        public DashBoardService(IVentaRepository repositorioVenta, IGenericRepository<DetalleVenta> repositorioDetalleVenta, 
        ...
        public async Task<Dictionary<string, int>> ProductosTopUltimaSemana()
        {
            try
            {
                ...
                Dictionary<string, int> resultado = query
                    ...
                    .Where(v => v.IdVentaNavigation.FechaRegistro.Value.Date >= FechaInicio.Date)
