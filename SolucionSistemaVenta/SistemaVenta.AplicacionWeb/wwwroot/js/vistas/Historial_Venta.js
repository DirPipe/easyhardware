...
$("#btnBuscar").click(function () {
    ...
    if ($("#cboBuscarPor").val() == "fecha") {
        ...
        if ($("#txtFechaInicio").val().trim() == "" || $("#txtFechaFin").val().trim() == "") {
            toastr.warning("", "Debe ingresar una fecha de inicio y una de fin!")
            return;
        }
    ...
    //const fechaInicio = new Date($("#txtFechaInicio").val()).toLocaleDateString("es-CO");
    //const fechaFin = new Date($("#txtFechaFin").val()).toLocaleDateString("es-CO");
